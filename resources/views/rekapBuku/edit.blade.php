...
@section('title')
    {{ trans('rekapBuku.title.edit') }}
@endsection

@section('breadcrumbs')
    {{ Breadcrumbs::render('edit_book_title', $rekap_buku) }}
@endsection

@section('content')
<div class="col-md-12 shadow">
	<div class="card-body">
		<form action="{{ route('rekap-buku.update', ['rekap_buku' => $rekap_buku]) }}" method="POST">
            @method('PUT')
			@csrf
            <div class="row align-items-center">
                ...
                <div class="col-8">
                    <select id="select_perpus" name="id_perpus"
                        ...
                        @if (old('id_perpus', $rekap_buku->id_perpus))
                            <option value="{{ old('id_perpus', $rekap_buku->profil)->id }}" selected>
                                {{ old('id_perpus', $rekap_buku->profil)->nmlembaga }}
                            </option>
                        @endif
                    </select>
                    @error('id_perpus')
			...
			<div class="row align-items-center">
                ...
                <div class="col-8">
                    ...
                    name="judul" value="{{ old('judul', $rekap_buku->judul) }}"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-8">
                    ...
                    name="eksemplar" value="{{ old('eksemplar', $rekap_buku->eksemplar) }}"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-8">
                    ...
                    name="tahun" value="{{ old('tahun', $rekap_buku->tahun) }}"
            ...
            <table style="width: 100%;">
                <td style="text-align: right;">
                    ...
                    <button type="submit" class="btn btn-primary">{{ trans('rekapBuku.button.edit') }}</button>
                </td>
            </table>
        </form>
    </div>
